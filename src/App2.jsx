        ...
        links: [
          {
            ...
            internal: true,
            url: "/clinical-control-tower/executive",
          },
          {
            name: "MTR Tracker",
            internal: true,
            url: "/clinical-control-tower/mtr",
          },
          {
            name: "DSR Tracker",
            internal: true,
            url: "/clinical-control-tower/dsr",
          },
          {
            name: "Shipment Monitor",
            internal: true,
            url: "/clinical-control-tower/shipments",
          },
          {
            name: "Inventory Reconciliation",
            internal: true,
            url: "/clinical-control-tower/inventory",
          },
          {
            name: "Exceptions & Alerts",
            internal: true,
            url: "/clinical-control-tower/exceptions",
          },
        ],
      },
    ],
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f7fb]">
      {/* HEADER */}
      <header className="relative overflow-hidden border-b border-slate-900 bg-[#000080]">
        <img
          src={header}
          alt="Header"
        ...
        <div className="relative mx-auto max-w-[1700px] px-10 py-5">
          <div className="flex items-center justify-between">
            <div className="flex">
              <div className="h-[70px] w-[110px] overflow-hidden rounded-lg bg-slate-200 shrink-0 mr-[20px]">
                <img
                  src={tower}
                  // alt={card.title}
          ...
          <button
            ...
            className={`flex h-[58px] w-[180px] items-center justify-center rounded-xl border text-[22px] font-black transition-all ${
              selectedMain === "Clinical"
                ? "border-slate-900 bg-[#000080] text-white shadow-md"
                ...
                <div key={category}>
                  ...
                  <div className="mb-4 rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-sm">
                    <div className="text-center">
                      ...
                      <div className="mx-auto mt-2 h-[3px] w-8 rounded-full bg-[#000080]" />
                    </div>
                  </div>
                      ...
                      >
                        {/* <div className="flex items-center gap-3 border-b border-slate-100 bg-slate-50 p-3">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="mt-2 h-[3px] w-8 rounded-full bg-[#000080]" />
                                  ...
                                  const content = (
                                    <>
                                      <div className="flex items-center gap-2">
                                        <span className="h-[5px] w-[5px] rounded-full bg-[#000080]" />
